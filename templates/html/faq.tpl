...
<p>Go to <a href="http://gravatar.com/emails/">Gravatar.com</a> and create an account with the same email address as the one you used here. Upload your avatar there, it will show up here, and on other gravatar-enabled sites.</p>
...
<p>Sure you can. Manemix is licenced under the BSD-3 open source license, and has a git repository set up at <a href="https://github.com/manemix/manemix/">github.com/manemix/manemix/</a>. Any contribution is welcome, and you are encouraged to join IRC for development discussion or help with the code.</p>

<h4>Do you have other cool stuff?</h4>
<p>We have a public rsync repository of every published track as MP3 at <var>rsync://manemix.org/tracks/library/</var>.</p>

<h3>Contact</h3>

<h4>I spotted a bug!</h4>
<p>Great! Let us know either via email at <var>contact@manemix.org</var> or on our <a href="http://github.com/manemix/manemix/issues/">issue tracker</a>.</p>

<h4>I've got a question/problem/idea!</h4>
<p>What are you waiting for? Drop us a line at <var>contact@manemix.org</var>.</p>
<p>Or <a title="#manemix on irc.ponychat.net" href="http://webchat.ponychat.net/?autojoin=%23manemix">chat with us</a> in <var>#manemix</var> on <var>irc.ponychat.net</var>. Don't be shy, we're friendly!</p>
...
<h4>Why is the chat so dead?</h4>
<p>Blame timezones. The chat is usually most active around 15:00 to 23:00 UTC, and even then it can be very slow some days. Try starting a discussion, or just lurk for a while.</p>
</div>
